...
if(config.template_engine.nunjucks.enabled){
  require('../adapters/nunjucks')(http2,config, server.cache);
} else if(config.template_engine.pug.enabled){
  require('../adapters/pug')(http2,config, server.cache);
} else if(config.template_engine.basic.enabled){
  require('../adapters/basic')(http2, config, server.cache);
}
